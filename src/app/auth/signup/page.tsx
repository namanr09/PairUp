...
const formSchema = z.object({
    name : z.string().min(2,{message : "name must be greater than 2 letters"}),
...
export default function page() {
  ...
  return (
    <div className="h-full flex  justify-center items-center  w-full ">
      <div className="flex flex-col items-center space-y-5 w-[400px] h-[500px] justify-center rounded-xl shadow-lg border ">
        <span className="font-bold text-3xl">Let's Start Building!
        </span>
        <Form {...form}>
          <form
